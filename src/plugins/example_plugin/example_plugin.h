...
extern vlib_node_registration_t example_plugin_node;
extern vlib_node_registration_t example_plugin_periodic_node;

/* Periodic function events */
#define EXAMPLE_PLUGIN_EVENT1 1
#define EXAMPLE_PLUGIN_EVENT2 2
#define EXAMPLE_PLUGIN_EVENT_PERIODIC_ENABLE_DISABLE 3

void example_plugin_create_periodic_process (example_plugin_main_t *);
